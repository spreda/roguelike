...
var _btn_left_arrow = instance_create_layer(100, room_height / 2, "Instances", obj_button_arrow);
_btn_left_arrow.set_direction("left");


var _btn_right_arrow = instance_create_layer(room_width - 100, room_height / 2, "Instances", obj_button_arrow);
...
var _btn_exit = instance_create_layer(200, 100, "Instances", obj_button_exit);
